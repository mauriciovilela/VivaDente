...
@Entity
@Table(name = "tb_agenda_historico")
public class TbAgendaHistorico implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TbAgendaHistorico other = (TbAgendaHistorico) obj;
		if (id == null) {
			if (other.id != null)
				return false;

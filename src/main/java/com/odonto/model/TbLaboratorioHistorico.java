...
@Entity
@Table(name = "tb_laboratorio_historico")
public class TbLaboratorioHistorico implements Serializable {
	...
	@NotNull
	private TbLaboratorio tbLaboratorio;
	
	public TbLaboratorioHistorico() {
	}
	...
	public TbLaboratorio getTbLaboratorio() {
		return tbLaboratorio;
	}

	public void setTbLaboratorio(TbLaboratorio tbLaboratorio) {
		this.tbLaboratorio = tbLaboratorio;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TbLaboratorioHistorico other = (TbLaboratorioHistorico) obj;
		if (id == null) {
			if (other.id != null)
				return false;
